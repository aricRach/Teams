(function (window) {
  ...
  window["env"]["NG_APP_FIREBASE_API_KEY"] = "${NG_APP_FIREBASE_API_KEY}";
  window["env"]["NG_APP_FIREBASE_AUTH_DOMAIN"] = "${NG_APP_FIREBASE_AUTH_DOMAIN}";
  window["env"]["NG_APP_FIREBASE_PROJECT_ID"] = "${NG_APP_FIREBASE_PROJECT_ID}";
